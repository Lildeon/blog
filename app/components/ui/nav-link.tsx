...
export function NavHead() {
  return (
    <header className=" flex justify-between items-center  text-white  bg-gray-500 md:px-5 px-1 pt-10 pb-5 container max-w-screen-xl mx-auto fixed top-0 left-0 right-0">
      <Link
        href={"/blog"}
