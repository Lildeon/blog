        ...
        {recent.length > 0 &&
          recent.map((p) => (
            <Link href={p.path} key={p.id}>
              ...
              <p
                className="whitespace-pre-line mt-5 font-semibold lg:text-2xl text-lg text-black sm:text-xl sm:hover:bg-gradient-to-r from-green-200 to-green-100 line-clamp-1"
                key={p.title}
              >
                {p.description}
              </p>
